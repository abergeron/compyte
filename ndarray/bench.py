...
if __name__ == "__main__":
    ...
    times_ap1 = {'pycuda':[2.19774413109e-05, 2.19221115112e-05, 4.95604705811e-05, 0.000240413618088, 0.000483848741055, 0.0024825881815],
             'GPU ndarray 1d contiguous':[5.62311887741e-05, 5.63329601288e-05, 5.65941119194e-05, 0.000271942930222, 0.000558048298359, 0.00291627338171],
             'GPU ndarray 4d contiguous':[6.96398019791e-05, 6.97722792625e-05, 6.97479104996e-05, 0.000272047069073, 0.000557991290092, 0.00264423480034],
             #'GPU ndarray 4d strided outer coallesced':[],
             #'GPU ndarray 4d strided outer':[],
             #'GPU ndarray 4d strided 4d':[],
                 }

    msa = [('pycuda', bench.try_pycuda, shapes_1d),
#           ('numpy 1d', bench.try_numpy, shapes_1d[:-1]),
           ('GPU ndarray 1d contiguous', bench.try_compyte, shapes_1d),
           #('GPU ndarray 2d', bench.try_compyte, shapes_2d),
           #('GPU ndarray 3d', bench.try_compyte, shapes_3d),
           ('GPU ndarray 4d contiguous', bench.try_compyte, shapes_4d)]
    msa2 = [('pycuda',
            ...
            ('GPU ndarray 1d contiguous',
             ...
             shapes_1d),
#            ('GPU ndarray 1d contiguous not collapsed',
...
#             lambda b, vals, ref: b.try_compyte(vals, reuse_output=True, ref=ref),
#             shapes_4d_strided_outer_coalesced),
#            ('GPU ndarray 4d strided middle(2d after collapse)',
#             lambda b, vals, ref: b.try_compyte(vals, reuse_output=True, ref=ref),
#             shapes_4d_strided_middle),
#            ('GPU ndarray 4d strided middle2(2d after collapse)',
#             lambda b, vals, ref: b.try_compyte(vals, reuse_output=True, ref=ref),
#             shapes_4d_strided_middle),
            ('GPU ndarray 4d strided outer(2d after collapse)',
             lambda b, vals, ref: b.try_compyte(vals, reuse_output=True, ref=ref),
             shapes_4d_strided_outer),
#            ('GPU ndarray 4d strided inner(1d after collapse)',
#             lambda b, vals, ref: b.try_compyte(vals, reuse_output=True, ref=ref),
#             shapes_4d_strided_inner),
            #('GPU ndarra 4d strided 4d',
            # lambda b, vals, ref: b.try_compyte(vals, reuse_output=True, ref=ref),
            # shapes_4d_strided4d),
            ]
